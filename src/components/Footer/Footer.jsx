    ...
    <div className="max-w-screen-xl mx-auto">
      <footer className="px-4 divide-y text-gray-100">
        <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
          ...
          <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-3 text-center">
            ...
            <div className="space-y-3 mx-auto col-span-3 sm:col-span-1">
        ...
        <div className="py-6 text-sm text-center text-gray-200">
          © 2023 BloodAid Co. All rights reserved.
        </div>
      </footer>
    </div>
  );
